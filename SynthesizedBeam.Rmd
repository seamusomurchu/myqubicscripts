...
for i in range(len(centers)):
    ...
    if i+1 in special:
        plt.plot(centers[i,0]-0.0005, centers[i,1]+0.0005, 'D', color='xkcd:burnt orange',  markersize=29, alpha=0.4, mfc = None)
        #plt.scatter(centers[i,0], centers[i,1], s=800, facecolors='none', edgecolors='r')
        
plt.ylabel('Horn Reference Frame Y (m)')
plt.xlabel('Horn Reference Frame X (m)')
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc35/specialhorns.png", bbox_inches='tight', facecolor='white')

```

```{python}
print(centers.shape, col.shape, row.shape)
```
...
cnt = 1
TDhornsFIconf = np.zeros(400, dtype=int)
...
print(FIhorns[np.where(TDhornsFIconf == 1)])

for i in range(len(FIhorns)):
    print(FIhorns[i], TDhornsFIconf[i])
```
...
plt.scatter(q.detector.center[:,0], q.detector.center[:,1], color='xkcd:teal blue', marker='s', s=600)
...
#plt.scatter(q.detector.center[testnum,0], q.detector.center[testnum,1], 
            #color ='xkcd:emerald', marker='s', s=600)
plt.scatter(q.detector.center[testnum2,0], q.detector.center[testnum2,1], 
            color ='xkcd:strawberry', marker='s', s=600)
#plt.scatter(q.detector.center[970,0], q.detector.center[970,1], color ='xkcd:diarrhea', marker='s', s=100)
#plt.text(q.detector.center[testnum,0]+0.0005, q.detector.center[testnum,1]+0.0008, '93', fontsize=20)
plt.text(q.detector.center[testnum2,0]+0.0005, q.detector.center[testnum2,1]+0.0007, '76', fontsize=20)

plt.ylim(-0.054, 0)
plt.xlim(-0.054, 0)
plt.xlabel('Focal Plane X (m)')
plt.ylabel('Focal Plane Y (m)')
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc6/detsonfp76.png", bbox_inches='tight', facecolor='white')
