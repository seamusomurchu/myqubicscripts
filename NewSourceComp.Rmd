...
```{python}
newcut = np.loadtxt(cuts[0], skiprows=3, delimiter=',').T
oldcut = np.loadtxt(cuts[1], skiprows=3, delimiter=',').T
gauscut = np.loadtxt(cuts[2], skiprows=3, delimiter=',').T
```
...
plt.plot(oldcut[0,:], oldcut[1,:], label='Previous Aperture Field', linewidth=3)
plt.plot(newcut[0,:], newcut[1,:], label='Updated Aperture Field', linewidth=3)
