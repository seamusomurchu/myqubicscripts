...
print(colar21.shape, len(colar21), colar21)
print(colar22.shape, len(colar22), colar22)
...
cols = np.add(colar11, colar12, colar13).tolist()
r = np.linspace(1, len(colar21), len(colar21))
#names = ["Col1ASIC1", "COL2ASIC1"]
width=1
plt.figure(figsize=(16,8))
plt.bar(r, colar11, color=current_palette[0], edgecolor='white', width=width)
