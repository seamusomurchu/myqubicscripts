...
for k in range(nplots):
    ...
    for i in range(nnx*nny):
        ...
        if ites < 256:
            ...
            #plt.savefig('/home/james/ghostimages/rerunv5/plots/goodtesplots/selectionplots{}'.format(k), bbox_inches='tight')
    plt.tight_layout()
    plt.show()
```
    ...
    for i in range(nnx*nny):
        ...
        if ites < 256:
            ...
            plt.imshow(flatmaps[ites,:,:], aspect='equal',
                   extent=[azmin, azmax, elmin, elmax])
            plt.title('TES {}'.format(ites+1), fontdict=font)
            #plt.savefig('/home/james/synthbeamdata/2020-07-30/selectionplots{}'.format(k), bbox_inches='tight')
    plt.tight_layout()
    plt.show()
```
