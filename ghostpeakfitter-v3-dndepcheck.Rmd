...
initial_guess1 = (max(flatmapg.ravel()), xys[0][0], xys[0][1], 1, 1, 0, 0)
# initial_guessg2 = (max(flatmapg.ravel()), xys[1][0], xys[1][1], 1, 1, 0, 0)
...
fit_params1, cov_mat1 = opt.curve_fit(twoD_Gaussian, (AZ, EL), flatmapg.ravel(), p0=initial_guess1)
data_fitted1 = twoD_Gaussian((AZ, EL), *fit_params1)
plt.contour(AZ, EL, data_fitted1.reshape(101, 101), 3, colors='k')
```
