...
# print(datmat.shape)
# with open('/home/james/ghostimages/rerun/objs_rerun2.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
...
plt.figure(figsize=(16,8))
plt.plot(r, angle, '.', color=current_palette[0], markersize=20)
...
plt.figure(figsize=(16,8))
plt.plot(r, ampr, '.', color=current_palette[3], markersize=20)
