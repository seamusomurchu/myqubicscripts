...
peaks, _ = find_peaks(zi, prominence=0.1)
...
peaks150, _ = find_peaks(zi150, prominence=0.75e6)
...
plt.xticks(np.arange(-18,18,step=1));
plt.xlim([-12, 12])
#plt.savefig("/home/james/OneDrive/Thesisv2/Figures/figsc6/simandmeasuredcut.png", bbox_inches='tight', dpi=300)
```
